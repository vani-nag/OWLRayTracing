    ...
    float &t, float &u, float &v)
{
    ...
    {
	printf("NO INTERSECTION: parallel\n");
    ...
    if (t < 0) 
    {
	printf("NO INTERSECTION: triangle is behind\n");
...
int main(int argc, char **argv)
{
    ...
    Vec3f *framebuffer = new Vec3f[width * height*2];
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
    for (uint32_t j = 0; j < height; ++j) {
        for (uint32_t i = 0; i < width; ++i) {
            ...
            dir.normalize();
            float t, u, v;
            if (rayTriangleIntersect(orig, dir, v3, v4, v5, t, u, v)) {
                // [comment]
                // Interpolate colors using the barycentric coordinates
                // [/comment]
                *pix = u * cols[0] + v * cols[1] + (1 - u - v) * cols[2];
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ofs << "P6\n" << width << " " << height << "\n255\n";
    for (uint32_t i = 0; i < height * width*2; ++i) {
